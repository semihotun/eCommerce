...
using Entities.Concrete.CategoriesAggregate; 
 ...
 public async Task<IActionResult> GetByCategorySpeficationId (GetByCategorySpeficationId request) { 
 ...
 [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(string))] 
 public async Task<IActionResult> GetAllCategorySpefication (GetAllCategorySpefication request) { 
