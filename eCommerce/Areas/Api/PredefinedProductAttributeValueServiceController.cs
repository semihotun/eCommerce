...
using Business.Services.ProductAggregate.PredefinedProductAttributeValues.PredefinedProductAttributeValueServiceModel; 
 ...
 [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(string))] 
 public async Task<IActionResult> GetPredefinedProductAttributeValues (GetPredefinedProductAttributeValues request) { 
 ...
 [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(string))] 
 public async Task<IActionResult> GetPredefinedProductAttributeValueById (GetPredefinedProductAttributeValueById request) { 
