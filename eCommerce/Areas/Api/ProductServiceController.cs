...
using Entities.Concrete.ProductAggregate; 
 ...
 public async Task<IActionResult> GetProduct (GetProduct request) { 
 ...
 [Produces("application/json", "text/plain")] 
 [HttpPost("mainsearchproduct")] 
 [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(string))] 
 [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(string))] 
 public async Task<IActionResult> MainSearchProduct ([FromBody]MainSearchProduct request) { 
 
 var result = await _productService.MainSearchProduct(request); 
 ...
 [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(string))] 
 public async Task<IActionResult> GetProductsBySpecificationAttributeId (GetProductsBySpecificationAttributeId request) { 
