#pragma checksum "C:\Users\Semih\source\repos\eCommerce\eCommerce\Areas\Admin\Views\AdminProduct\AttrMaping\AttrMapping.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e3a50f60d5eaf3e019ca0b5aef24440e6507fb7a"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Areas_Admin_Views_AdminProduct_AttrMaping_AttrMapping), @"mvc.1.0.view", @"/Areas/Admin/Views/AdminProduct/AttrMaping/AttrMapping.cshtml")]
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"e3a50f60d5eaf3e019ca0b5aef24440e6507fb7a", @"/Areas/Admin/Views/AdminProduct/AttrMaping/AttrMapping.cshtml")]
    #nullable restore
    public class Areas_Admin_Views_AdminProduct_AttrMaping_AttrMapping : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<Entities.ViewModels.AdminViewModel.AdminProduct.ProductVM>
    #nullable disable
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            WriteLiteral("\r\n\r\n");
#nullable restore
#line 4 "C:\Users\Semih\source\repos\eCommerce\eCommerce\Areas\Admin\Views\AdminProduct\AttrMaping\AttrMapping.cshtml"
...
#nullable disable
#nullable restore
#line 5 "C:\Users\Semih\source\repos\eCommerce\eCommerce\Areas\Admin\Views\AdminProduct\AttrMaping\AttrMapping.cshtml"
...
<script>
                        ...
                        <div class=""card-header p-0 d-flex position-relative"" id=""${""collapseHeading"" + item.Id}"">
                            <button type=""button"" class=""btn text-left w-100 p-4 btn-neutral d-flex "" onclick=""GetMappingAttribute(${item.Id})"" id=""${""MappingButton"" + item.Id}""
                                ...
                                <span class=""h1 vertical-absolute-right-center mr-4"">
                                    <a onclick=""AttrMapingEdit(${item.Id})"" class=""b");
            WriteLiteral(@"tn btn-outline-default"">
                        ...
                        <div id=""${""collapse"" + item.Id}"" class=""collapse"" aria-labelledby=""${""collapseHeading"" + item.Id}"" data-parent=""#accordion"">
                            ...
                            ");
            WriteLiteral(@"                <td>Ağırlık Ayarlaması</td>
                                            <td>Seçili gelsin</td>
                                            <td>Sıralaması</td>
                                            <td> </td>
                                        </tr>
    ...
    $(""#mappingAdd"").click(function () {
        ...
        var productMapping = {
            ...
            TextPrompt: TryString($(""input[name='ProductAttributeMappingModel.TextPromp");
            WriteLiteral(@"t']"").val()),
    ...
    function DeleteAttributeValue(id) {
        $.ajax({
            url: ""/Admin/ProductAttributeMapping/ProductAttributeValueDelete?AttributeValueid="" +");
            WriteLiteral(@" id,
            type: ""GET"",
            success: function (data) {
    ...
    function AddProductMappingAttributeValue() {
        ProductModel.ProductAttributeValue.Name = TryString($(""input[name='P");
            WriteLiteral(@"roductAttributeValue.Name']"").val());
        ...
        ProductModel.ProductAttributeValue.ProductAttributeMappingId = TryInt($(""input[name='ProductAt");
            WriteLiteral(@"tributeValue.ProductAttributeMappingId']"").val());
        ...
        if (ProductModel.ProductAttributeValue.Id === 0) {
            ...
            $.ajax({
                ...
                error: func");
            WriteLiteral(@"tion (xhr, status, error) {
  ...
  ");
            WriteLiteral(@"  function AddProductMappingAttributeValueTable(item, mappingId) {
