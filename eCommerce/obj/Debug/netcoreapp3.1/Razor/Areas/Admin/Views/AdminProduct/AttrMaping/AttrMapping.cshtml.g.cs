#pragma checksum "C:\Users\Semih\source\repos\eCommerce\eCommerce\Areas\Admin\Views\AdminProduct\AttrMaping\AttrMapping.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "fc39d028d7ddf0dadc252ba9a7bfbd3fcd0091f7"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"fc39d028d7ddf0dadc252ba9a7bfbd3fcd0091f7", @"/Areas/Admin/Views/AdminProduct/AttrMaping/AttrMapping.cshtml")]
    public class Areas_Admin_Views_AdminProduct_AttrMaping_AttrMapping : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<Entities.ViewModels.Admin.ProductModel>
    {
...
<script>
    ...
    function GetMappingAttribute(id) {
        ...
        $.ajax({
      ");
            WriteLiteral(@"      url: ""/Admin/AdminProduct/ProductAttributeValueList?productAttrMapingId="" + id,
            type: ""GET"",
            success: function (data) {
                $.each(data,
                    function (index, item) {
    ...
    function AddProductMappingAttributeValue() {
     ...
     ");
            WriteLiteral(@"   ProductModel.ProductAttributeValue.Id = TryInt($(""input[name='ProductAttributeValue.Id']"").val());
        ...
        ProductModel.ProductAttributeValue.ProductAttributeMappingId = TryInt($(""input[name='ProductAttributeValue.ProductAttributeMappingId']"").v");
            WriteLiteral(@"al());
    ...
    function EditFillAttributeValue(id) {
        $.ajax({
            ...
            success: function (data) {
                ...
                $(""input");
            WriteLiteral(@"[name='ProductAttributeValue.Id']"").val(data.Id);
            }
        });
