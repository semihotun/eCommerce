...
namespace eCommerce.Areas.Api
{
    ...
    public class ProductSpecificationAttributeQueryServiceController : ControllerBase
    {
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(Core.Utilities.PagedList.IPagedList<Entities.Concrete.ProductSpecificationAttribute>))]
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(string))]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(Entities.Concrete.ProductSpecificationAttribute))]
