...
{
    public class ProductAttributeFormatterService : IProductAttributeFormatterService
    {
        #region field
        private readonly IProductAttributeMappingDtoQueryService _productAttributeMappingDtoQueryService;
        #endregion
        #region ctor
        public ProductAttributeFormatterService(IProductAttributeMappingDtoQueryService productAttributeMappingDtoQueryService)
        {
